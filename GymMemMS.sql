...
CREATE TABLE Venues (
    ...
    CONSTRAINT fk_venue_zip FOREIGN KEY (Zipcode)
        REFERENCES Zipcodes(Zipcode) ON UPDATE CASCADE
);
...
CREATE TABLE Members (
    ...
    PlanID INT NOT NULL,
    Zipcode VARCHAR(10) NOT NULL,
    CONSTRAINT fk_member_plan FOREIGN KEY (PlanID)
        REFERENCES MembershipPlans(PlanID) ON UPDATE CASCADE,
    CONSTRAINT fk_member_zip FOREIGN KEY (Zipcode)
        REFERENCES Zipcodes(Zipcode) ON UPDATE CASCADE
);
...
CREATE TABLE Staff (
    ...
    Phone VARCHAR(20) NOT NULL,
    Zipcode VARCHAR(10) NOT NULL,
    CONSTRAINT fk_staff_zip FOREIGN KEY (Zipcode)
        REFERENCES Zipcodes(Zipcode) ON UPDATE CASCADE
);
...
CREATE TABLE Classes (
    ...
    CONSTRAINT fk_class_staff FOREIGN KEY (StaffID)
        REFERENCES Staff(StaffID) ON UPDATE CASCADE,
    CONSTRAINT fk_class_venue FOREIGN KEY (VenueID)
        REFERENCES Venues(VenueID) ON UPDATE CASCADE
);
